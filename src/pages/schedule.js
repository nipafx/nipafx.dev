...
const SchedulePage = ({ data }) => {
	...
	const description = `I regularly [stream on Twitch](https://twitch.tv/nipafx), [speak at conferences](/talks) and occasionally give [Java courses](/courses) in a public forum. Here's the schedule for the coming months.`
