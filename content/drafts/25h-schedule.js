...
import style from "./25h-schedule.module.css"

const SchedulePage = () => (
	<section className="article">
		<div className={style.header}>
			<h1 className={style.date}>Timeline</h1>
		</div>
		...
		<div className={style.entry} style={{ gridArea: area }}>
			<div className={style.content}>
				<p className={style.date}>
					...
					{endDate && (<span className={style.endTime}>{time(endDate)}</span>)}
				</p>
...
const time = date => {
	...
	return date.getHours() + ":" + minutes + " UTC"
}
