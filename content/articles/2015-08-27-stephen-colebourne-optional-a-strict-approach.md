...
<contentimage slug="optional-a-strict-approach"></contentimage>
...
``` {.lang:java .decode:true title="Address.java By Stephen Colebourne" data-url="https://gist.githubusercontent.com/nicolaiparlog/5b2b7c84d71426a368c9/raw/143d4d4b305ef5bb751fa33ffeb15e4df8ae215d/StephensAddress.java"}
```
...
``` {.lang:java .decode:true title="Address.java By Me (Basic Version)" data-url="https://gist.githubusercontent.com/nicolaiparlog/230614b4e0a1d11b89dd/raw/466b6a0b8dcc64111acaf35edda657aaa3d44895/NicolaisBasicAddress.java"}
```
...
``` {.lang:java .range:34-50 .decode:true title="Obvious Optional Is Obvious" data-url="https://gist.githubusercontent.com/nicolaiparlog/20d7e831bf3585c3aaca/raw/dee68ca96bf6212f4efa8cf14325274c59503afc/NicolaisExtendedAddress.java"}
```
...
I consider [this to be solved](http://blog.codefx.org/java/serialize-optional/#Fields-Of-Type-Optional).
...
``` {.lang:java .range:9-32 .decode:true title="Overloaded Constructor To Avoid Creating Optionals" data-url="https://gist.githubusercontent.com/nicolaiparlog/20d7e831bf3585c3aaca/raw/dee68ca96bf6212f4efa8cf14325274c59503afc/NicolaisExtendedAddress.java"}
```
...
``` {.lang:java .range:76-96 .decode:true title="Overloaded Setters To Avoid Creating Optionals" data-url="https://gist.githubusercontent.com/nicolaiparlog/20d7e831bf3585c3aaca/raw/dee68ca96bf6212f4efa8cf14325274c59503afc/NicolaisExtendedAddress.java"}
```
...
This should [free up your mind](http://blog.codefx.org/techniques/intention-revealing-code-java-8-optional/#The-Effects) to think about more relevant problems.
...
Or wait for [value types](http://blog.codefx.org/tag/value-types/).
