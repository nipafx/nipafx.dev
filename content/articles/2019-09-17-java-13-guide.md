...
-   `String::stripIndent` behaves just like the algorithm the compiler uses to [remove indentation of text blocks](https://blog.codefx.org/java/text-blocks/-and-indentation).
